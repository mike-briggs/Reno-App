    ...
    return (
      <Block>
        <Block center bottom flex={0.4}>
          <Text h1 center bold>
            Your Home.
            <Text h1 primary> Renovated.</Text>
          </Text>
...
Welcome.defaultProps = {
  illustrations: [
    { id: 1, source: require('../assets/images/Welcome.png') },
    { id: 2, source: require('../assets/images/Welcome2.png') },
    { id: 3, source: require('../assets/images/Welcome1.png') },
  ],
};
